...
import {
  ...
  type EditThreadFollowUpInput,
  type InterruptThreadTurnInput,
  type PromoteThreadFollowUpInput,
  type QueueThreadFollowUpInput,
  type RemoveThreadFollowUpInput,
  type ReorderThreadFollowUpInput,
...
export type {
  ...
  CreateThreadInput,
  DeleteThreadInput,
  EditThreadFollowUpInput,
  InterruptThreadTurnInput,
  PromoteThreadFollowUpInput,
  QueueThreadFollowUpInput,
  RemoveThreadFollowUpInput,
  ReorderThreadFollowUpInput,
...
export function createThreadEnvironmentAtoms<R, E>(
  ...
  return {
    ...
    queueFollowUp: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:queue-follow-up",
      execute: (input: QueueThreadFollowUpInput) => queueThreadFollowUp(input),
      scheduler,
      concurrency,
    }),
    editFollowUp: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:edit-follow-up",
      execute: (input: EditThreadFollowUpInput) => editThreadFollowUp(input),
      scheduler,
      concurrency,
    }),
    removeFollowUp: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:remove-follow-up",
      execute: (input: RemoveThreadFollowUpInput) => removeThreadFollowUp(input),
      scheduler,
      concurrency,
    }),
    reorderFollowUp: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:reorder-follow-up",
      execute: (input: ReorderThreadFollowUpInput) => reorderThreadFollowUp(input),
      scheduler,
      concurrency,
    }),
    promoteFollowUp: createEnvironmentCommand(runtime, {
      label: "environment-data:commands:thread:promote-follow-up",
      execute: (input: PromoteThreadFollowUpInput) => promoteThreadFollowUp(input),
      scheduler,
      concurrency,
    }),
  };
