...
describe("OrchestrationReactor", () => {
  ...
  it("starts provider ingestion, provider command, checkpoint, thread deletion, and follow-up queue reactors", async () => {
    ...
    runtime = ManagedRuntime.make(
      Layer.effect(OrchestrationReactor, makeOrchestrationReactor).pipe(
        ...
        Layer.provideMerge(
          Layer.succeed(FollowUpQueueReactor, {
            start: () => {
              started.push("follow-up-queue-reactor");
              return Effect.void;
            },
            drain: Effect.void,
          }),
