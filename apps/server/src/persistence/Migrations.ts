...
import Migration0041 from "./Migrations/041_ProjectionThreadQueuedFollowUps.ts";
import Migration0042 from "./Migrations/042_ProjectionThreadsDropSettled.ts";
import Migration0043 from "./Migrations/043_ProjectionThreadSessionQuietSince.ts";
...
export const migrationEntries = [
  ...
  [41, "ProjectionThreadQueuedFollowUps", Migration0041],
  [42, "ProjectionThreadsDropSettled", Migration0042],
  [43, "ProjectionThreadSessionQuietSince", Migration0043],
] as const;
