import { CommandId, MessageId, ProjectId, QueuedFollowUpId, ThreadId } from "@t3tools/contracts";
...
export const newQueuedFollowUpId = (): QueuedFollowUpId => QueuedFollowUpId.make(randomUUID());
